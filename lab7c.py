...
def time_to_sec(t):
    return t.hour * 3600 + t.minute * 60 + t.second # Convert time

def sec_to_time(seconds):
    t = Time()  
    minutes, t.second = divmod(seconds, 60) # quotient, remainder
    t.hour, t.minute = divmod(minutes, 60)  # Get Total hours & minutes
    return t
